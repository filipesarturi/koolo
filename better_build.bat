...
if defined SCRIPT_ALREADY_RUNNING (
    exit /b 0
)
set SCRIPT_ALREADY_RUNNING=1

:: Jump to initialization to skip function definitions
goto :init

:: ============================================================================
:: FUNCTION DEFINITIONS (must be defined before being called)
:: ============================================================================
...
:main
:: Prevent double execution of main
if defined MAIN_ALREADY_EXECUTED (
    goto :eof
)
set MAIN_ALREADY_EXECUTED=1
...
:: ============================================================================
:: MAIN INITIALIZATION (entry point after goto :init)
:: ============================================================================
